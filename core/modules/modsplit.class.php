...
/**
 * 	\defgroup	split	split module
 * 	\brief		split module descriptor.
 * 	\file		core/modules/modsplit.class.php
 * 	\ingroup	split
 * 	\brief		Description and activation file for module split
 */
include_once DOL_DOCUMENT_ROOT . "/core/modules/DolibarrModules.class.php";

/**
 * Description and activation class for module split
 */
class modsplit extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->editor_name = 'https://www.atm-consulting.fr';
		// Id for module (must be unique).
		// Use a free id here
		// (See in Home -> System information -> Dolibarr for list of used modules id).
		$this->numero = 104430; // 104000 to 104999 for ATM CONSULTING
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'split';
		...
		// for specific css file (eg: /split/css/split.css.php)
		...
		// Example: this->dirs = array("/split/temp");
		$this->dirs = array();
		...
		$this->langfiles = array("split@split"); // langfiles@split
		// Constants
		...
		$this->tabs = array(
			...
			//	'objecttype:+tabname1:Title1:langfile@split:$user->rights->split->read:/split/mynewtab1.php?id=__ID__',
			//	// To add another new tab identified by code tabname2
			//	'objecttype:+tabname2:Title2:langfile@split:$user->rights->othermodule->read:/split/mynewtab2.php?id=__ID__',
		...
		/* Example:
		  ...
		  if (! isset($conf->split->enabled)) $conf->split->enabled=0;
		  $this->dictionnaries=array(
		  'langs'=>'split@split',
		...
		//	'type'=>'top',
		//	'titre'=>'split top menu',
		//	'mainmenu'=>'split',
		//	'leftmenu'=>'split',
		//	'url'=>'/split/pagetop.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
		//	// Define condition to show or hide menu entry.
		//	// Use '$conf->split->enabled' if entry must be visible if module is enabled.
		//	'enabled'=>'$conf->split->enabled',
		//	// Use 'perms'=>'$user->rights->split->level1->level2'
		...
		//	'type'=>'left',
		//	'titre'=>'split left menu',
		//	'mainmenu'=>'split',
		//	'leftmenu'=>'split',
		//	'url'=>'/split/pagelevel1.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
	 ...
	 * and create data commands must be stored in directory /split/sql/
	...
	{
		return $this->_load_tables('/split/sql/');
	}
}
